...
class exchange_from_returned_lines(osv.osv_memory):
    ...
    _columns = {
        'exchange_line_ids' : fields.many2many('temp.exchange.line','temp_exchange_line_rel', 'partner_id', 'category_id', string='Selected exchange lines'),
        # 'return_line_ids' : fields.many2many('temp.return.line', 'temp_return_line_rel', 'partner_id', 'category_id', string='Return lines'),
    }
