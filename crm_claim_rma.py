...
class return_line(osv.osv):
    ...
    _columns = {
        ...
        'claim_origine': fields.selection([('none','Non Specificato'),
                                    ('legal','Recesso Legale'),
                                    ('cancellation','Cancellazione Ordine'),
                                    ('damaged','Danneggiato alla consegna'),                                    
                                    ('error','Errore di Spedizione'),
                                    ('exchange','Richiesta Sostituzione'),
                                    ('lost','Perso nel Trasporto'),
                                    ('other','Altro')], 'Oggetto ', required=True, help="To describe the line product problem"),
        'claim_descr' : fields.text('Descrizione Estesa', help="More precise description of the problem"),  
        ...
        'applicable_guarantee': fields.selection([('us','Azienda'),('supplier','Fornitore'),('brand','Brand Produttore')], 'Tipo Garanzia'),# METTRE CHAMP FONCTION; type supplier might generate an auto draft forward to the supplier
        'guarantee_limit': fields.date('Scadenza Garanzia', help="Limite calcolato dalla data di acquisto e ciò che è definito sull'articolo", readonly=True),
        ...
        'state' : fields.selection([('draft','Bozza'),
                                    ('refused','Rifiutata'),
                                    ('confirmed','Confermato, Attesa Prodotto'),
                                    ('in_to_control','Ricevuto, da controllare'),
                                    ('in_to_treate','Controllato, da lavorare'),
                                    ('in_produ','in Lavorazione/Produzione'),
                                    ('treated','Lavorato')], 'State'),
